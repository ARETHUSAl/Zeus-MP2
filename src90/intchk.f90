...
!
      call MPI_BCAST(tused, 1, MPI_DOUBLE_PRECISION, 0, comm3d, ierr)
!
...
!
      icheckn = 1
      if (myid .eq. 0) nchar = checkin_(msg,icheckn)
!
...
!
      if (msg(1:3) .eq. 'tli') then
        ...
        call bcdflt_(msg,valnew,(istrt-1),(iend-istrt+1))
