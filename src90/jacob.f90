...
!
!     completes the jacobian and the RHS for the Newton-Raphson
!     solution to the implicit radiation energy equation
!
!     written by: John C. Hayes; March, 1997
!
!     modified for F90 by J. Hayes; May, 2003
!
      use real_prec
      use config
      use param
...
!
!======================================================================
!     Do all the points owned by this tile, and then alter any
!     values that lie on a boundary, if appropriate.
!======================================================================
!
!     individual terms for the main diagonal and the RHS
!
      if(ldimen .eq. 1) then
       jsm2 = js
       jep1 = je
...
!
      ...
      enddo
!
!     compute the main diagonal and the RHS
!
      do k = ks, ke
       do j = js, je
        do i = is, ie
...
!
!======================================================================
!     Physical boundaries.  In the case of reflecting or in-flow
!     b.c.'s, the value of the main diagonal at physical boundaries
!     must be altered.  For the other b.c. types currently supported,
!     no further change is necessary as the derivatives are unaffected
!     in those cases.
!======================================================================
!
