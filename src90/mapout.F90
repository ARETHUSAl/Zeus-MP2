...
!
!     PURPOSE: maps ZEUS-MP arrays into restart file arrays
!
...
!
      ...
      if(xhse) then
       call put_field_reals(gp1, index)
       call put_field_reals(gp2, index)
       call put_field_reals(gp3, index)
      endif
...
!
      ...
      rlrtvr(39) = trem
      rlrtvr(40) = tsave
!JH  -- storing tused causes restart files to fail "diff" test for
!JH     repeatability check
      rlrtvr(41) = 0.0 ! tused
      rlrtvr(42) = tusr
      rlrtvr(43) = ttsl
      rlrtvr(44) = v1floor
