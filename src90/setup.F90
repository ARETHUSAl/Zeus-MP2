...
!  according to the flags and values in the input deck.  Calls PROBLEM
...
!  user must define PROBLEM to be the appropriate subroutine name in the
...
!-------------------------  PROBLEM GENERATOR  -------------------------
!
!  PROBLEM is a user-defined cpp macro name representing a subroutine
!  which intializes all field variables for the particular problem to
!  be studied.  PROBLEM should initialize the field variable arrays 
...
!  the constraint DIV(B)=0 PROBLEM should initialize
