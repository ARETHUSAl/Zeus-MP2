...
!
      do 30 j=js-2,je+2
       ...
       if(lgeom .eq. 2) then
        g32ah (j) =   0.5*(x2a(j) + x2an(j))
        g32bh (j) =   0.5*(x2b(j) + x2bn(j))
        g4ah  (j) = 0.125*(x2a(j) + x2an(j))**2
        g4bh  (j) = 0.125*(x2b(j) + x2bn(j))**2
        g32an (j) =     x2an(j)
        g32bn (j) =     x2bn(j)
        g4an  (j) = 0.5*x2an(j)**2
        g4bn  (j) = 0.5*x2bn(j)**2
       ...
       if(lgeom .eq. 3) then
        g32ah (j) =  sin(0.5*(x2a(j) + x2an(j)))
        g32bh (j) =  sin(0.5*(x2b(j) + x2bn(j)))
        g4ah  (j) = -cos(0.5*(x2a(j) + x2an(j)))
        g4bh  (j) = -cos(0.5*(x2b(j) + x2bn(j)))
        g32an (j) =  sin(x2an (j))
        g32bn (j) =  sin(x2bn (j))
        g4an  (j) = -cos(x2an (j))
        g4bn  (j) = -cos(x2bn (j))
