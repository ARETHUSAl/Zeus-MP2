...
!
!----------------------------------------------------------------------
!        COPY TO REPLACE ADVX3 CALL
!----------------------------------------------------------------------
!
         do j = js, je
          do i = is, ie
           d   (i,j,ks) = w3dd(i,j,ks)
           w3dg(i,j,ks) = w3de(i,j,ks)
          enddo
         enddo
         if(nspec .gt. 1) then
          do n = 1, nspec
