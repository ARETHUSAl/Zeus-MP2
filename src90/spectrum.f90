...
! spectrum to evaluate the */- photodetachment rate coefficient k27 as  
! well as the */+ photodissociation rate k28 below the */ ionization edge
!          delta_u = 0.05
!          LSnm    = 0.0
!          do n=1,2000
!            u     = n * delta_u
...
! to compute the */ photodissociation rate k31 in mnu_dir_flx.F
!          if (iLW .eq. 1) then
!            delta_u = 0.1
!            LSnm    = 0.0
!            do n=1,1000
