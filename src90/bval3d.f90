       ...
       if (niis(1).eq.0 .or. niis(1).eq.4) then
         if (l1 .gt. 0) then
           ...
           if (l1.ge.2) then
             ...
             , MPI_DOUBLE_PRECISION, n1m ,1175+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(1,1) = rl1
         endif
       ...
       if (nois(1).eq.0 .or. nois(1).eq.4) then
         ...
         if (l1 .gt. 0) then
           ...
           if (l1 .ge. 2) then
             ...
             , MPI_DOUBLE_PRECISION, n1p ,1175+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(1,1) = rl1
         endif
       ...
       if (nijs(1).eq.0 .or. nijs(1).eq.4) then
         if (l2 .gt. 0) then
           ...
           if (l2 .ge. 2) then
             ...
             , MPI_DOUBLE_PRECISION, n2m ,1375+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(3,1) = rl2
         endif
       ...
       if (nojs(1).eq.0 .or. nojs(1).eq.4) then
         ...
         if (l2 .gt. 0) then
           ...
           if (l2 .ge. 2) then
             ...
             , MPI_DOUBLE_PRECISION, n2p,1375+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(3,1) = rl2
         endif
       ...
       if (niks(1).eq.0 .or. niks(1).eq.4) then
         if (l3 .gt. 0) then
           ...
           nreq = nreq + 1
             ...
             , MPI_DOUBLE_PRECISION, n3m ,1575+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(5,1) = rl3
         endif
       ...
       if (noks(1).eq.0 .or. noks(1).eq.4) then
         ...
         if (l3 .gt. 0) then
           ...
           if (l3 .ge. 2) then
             ...
             , MPI_DOUBLE_PRECISION, n3p,1575+nsub, comm3d &
             , req(nreq), ierr)
           endif
           bvstat(5,1) = rl3
         endif
...
!#if benchmark == advect  --   I wish cpp could do this!
...
!#if alias benchmark.eq.advect  -- I wish!
