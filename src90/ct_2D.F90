...
!                into ZEUS-MP form.
!    modified 7: John Hayes, October 2005; created ct_2D clone which
!                assumes symmetry about the K axis; after ZEUS3D.
!
