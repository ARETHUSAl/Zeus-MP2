...
subroutine h4splice
!
! ZEUS-MP Post-processor: HSPLICE.
!
! PURPOSE:  This program reads all HDFDUMPS from a ZEUS-MP run
!           and assembles them into a single huge file which looks
!           like one from a single-processor job with the same
!           physical mesh.
!
! LAST MODIFIED: PSLi, 12/30/99.
!
!.......................................................................
!
      use real_prec
...
!       !rewind(1)
       ...
       , ntiles(3)
!
!   Read the _rescon_ namelist to find the runs id.
!
       irestart = 0
        tdump = 0.0
       dtdump = 0.0
...
!.......................................................................
!
! Read each function from each tiles dump and write it into
